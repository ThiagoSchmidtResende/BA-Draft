********************************************************************************
*					Number of reviews, ONLY BY RACE & FEMALE				   *
********************************************************************************
preserve
keep if sample == 1
#delimit ;
quietly reg log_number_of_reviews i.race_res i.sex_res i.age,  
...
#delimit ;
quietly reg log_number_of_reviews i.race_res i.sex_ i.age 
			i.group_neighbourhood_cleansed i.cleaned_city  
...
esttab model1 model2 model3 model4 using
	"$repository/code/tables/tex_output/individual_tables/number_reviews.tex", 
		...
		keep(_cons *.race_sex_res) drop(1.race_res 1.sex)
