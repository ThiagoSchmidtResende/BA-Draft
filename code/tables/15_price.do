...
keep if sample == 1
// Base
quietly reg log_price i.race_res i.sex_res i.age, vce(cluster group_neighbourhood_cleansed) 
eststo model1
			
			
// Add location FEs		
#delimit ; 
quietly reg log_price i.race_res i.sex_res i.age
...
// Add host FEs
#delimit ;
quietly reg log_price i.race_res i.sex_res i.age i.group_ra_name
			i.group_neighbourhood_cleansed i.cleaned_city 
			i.group_property_type i.group_room_type 
			accommodates bathrooms bedrooms beds i.group_bed_type 
			cleaning_fee extra_people num_amenities 
