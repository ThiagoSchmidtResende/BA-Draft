...
quietly reg log_price i.race_sex_res i.age i.group_ra_name
			...
			neighborhood_subjectivity  //Quality of listing/effort of host - OKAY THRU HERE
			...
			miss_summary_subjectivity miss_space_polarity miss_space_subjectivity miss_neighborhood_polarity         
			miss_neighborhood_subjectivity,
			vce(cluster group_neighbourhood_cleansed) 
;
#delimit cr
eststo model4	
